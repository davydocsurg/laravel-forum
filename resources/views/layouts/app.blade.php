        ...
        <main class="container py-4">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="mb-3">
                        @auth
                            <a href="{{ route('discussions.create') }}" class="btn btn-info w-100 text-white">
                                <i class="fas fa-plus-circle"></i> Discussion
                            </a>

                        @else

                            <a href="{{ route('login') }}" class="btn btn-info w-100 text-white">
